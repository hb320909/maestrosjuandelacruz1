...
document.getElementById('addStudentForm').addEventListener('submit', async function(e) {
    ...
    const student = {
        ...
        telefono: document.getElementById('studentTelefono1').value,
        habitacion: null
    };
...
window.openStudentSeguimiento = openStudentSeguimiento;
window.deleteStudent = deleteStudent;
window.deleteAbsence = deleteAbsence;
window.editStudent = editStudent;
window.assignRoomToStudent = assignRoomToStudent;
...
window.clearHomework = clearHomework;
window.loadWeekFromReview = loadWeekFromReview;
window.showWeekReview = showWeekReview;